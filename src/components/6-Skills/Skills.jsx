    ...
    <div>
      ...
      <div className="flex All-flex">
        <div className="Rightskills flex">
          ...
          <div className="flex">
            <img
              src="https://corsatiforall.com/wp-content/uploads/2021/05/php.jpg"
              className="img-skills Redux"
              alt=""
            />
            <h4 className="h4-skills">Php</h4>
          </div>
          <div className="flex">
            <img
              src="https://res.cloudinary.com/dprfoqe2j/image/upload/v1723929512/pngegg_trxq4u.png"
              className="img-skills Redux"
              alt=""
            />
            <h4 className="h4-skills">Laravel</h4>
          </div>
        </div>
